...
public class ConfigurationTest {
	...
	public void getArray() throws Exception {
		...
		assertEquals("array[1] should equal \"b\"", "b", arrayValue.get(1));
		assertEquals("array[2] should equal \"c\"", "c", arrayValue.get(2));
		assertEquals("array[3] should equal \"d\"", "d", arrayValue.get(3));
